...
const Skincare = () => {
  // Generate skincare product images (product_0046.jpg to product_0115.jpg)
  ...
  for (let i = 46; i <= 115; i++) {
    ...
    skincareProducts.push({
      ...
      name: `Skincare Product ${i}`, // Placeholder name - can be updated manually later
      price: Math.floor(Math.random() * 4000) + 800, // Random price for demo
    });
  }
